 ...
 * Use the {@link CuliFragment#newInstance} factory method to
...
public class CuliFragment extends Fragment {
    ...
    public static CuliFragment newInstance(int param1, String param2) {
        CuliFragment fragment = new CuliFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_culi, container, false);
